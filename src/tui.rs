...
impl App {
    ...
    /// env vars; None keeps the default (12 outer rows, full terminal
    /// columns, i.e. 10 content rows and 100 content columns).
...
/// Outer popup height: two border rows plus up to 10 content rows.
const OUTER_ROWS: usize = 12;
